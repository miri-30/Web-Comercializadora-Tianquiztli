...
export class ChatService {
  ...
  public returnContacts() {
    return this.realtimeDatabase.list('sa_empresas/').valueChanges();
  }  
  // Metodo publico para retornar la lista de contactos
  ...
  public bigFilter(chatCode) {
    return this.realtimeDatabase.list('chatb/chats/', ref => ref.orderByChild('chatId').equalTo(chatCode)).valueChanges();
  }
  // Metodo para filtro masivo
}
